...
void escape_dch(term_t_i *term);
void escape_dch1(term_t_i *term);
void escape_dl(term_t_i *term);
void escape_dl1(term_t_i *term);
void escape_ech(term_t_i *term);
...
void escape_khome(term_t_i *term);
void escape_kich1(term_t_i *term);
...
void escape_op(term_t_i *term);
void escape_rc(term_t_i *term);
void escape_rep(term_t_i *term);
void escape_rev(term_t_i *term);
void escape_ri(term_t_i *term);
void escape_rin(term_t_i *term);
void escape_rmacs(term_t_i *term);
void escape_rmam(term_t_i *term);
void escape_rmkx(term_t_i *term);
void escape_rmpch(term_t_i *term);
void escape_rmso(term_t_i *term);
void escape_rmul(term_t_i *term);
void escape_rs2(term_t_i *term);
void escape_s0ds(term_t_i *term);
void escape_s1ds(term_t_i *term);
void escape_s2ds(term_t_i *term);
void escape_s3ds(term_t_i *term);
void escape_sc(term_t_i *term);
void escape_setab(term_t_i *term);
void escape_setaf(term_t_i *term);
...
void escape_smpch(term_t_i *term);
void escape_smso(term_t_i *term);
void escape_smul(term_t_i *term);
void escape_tbc(term_t_i *term);
void escape_u6(term_t_i *term);
void escape_u7(term_t_i *term);
void escape_u8(term_t_i *term);
void escape_u9(term_t_i *term);
